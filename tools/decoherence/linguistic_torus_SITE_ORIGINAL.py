...
# ==========================================
print("Rendering Linguistic Decoherence (1990-2024)... This will take ~60 seconds.")
...
timeline_bg = ax_time.plot([1990, 2024], [0.5, 0.5], color='#333333', linewidth=4, zorder=1)[0]
...
# ==========================================
def update(frame):
    # 80 frames of movement mapping 1990-2024 (34 years), 20 hold frames
    t_linear = min(frame / 80.0, 1.0)
    current_year = 1990 + (t_linear * 34)
...
anim.save('linguistic_decoherence.gif', writer='pillow', savefig_kwargs={'facecolor': '#0d1117'})
print("Saved -> 'linguistic_decoherence.gif'")
